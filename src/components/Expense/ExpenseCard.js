...
const ExpenseCard = (props) => {
  const handleDelete = () => {
    console.log("props.expense.expense_id :::"+props.expense)
        ...
        <CardText className="flex-sb-m">
          ...
          <span>
            <Link to={`/expense/edit`}>
              <i id={`expenseEdit_${props.expense.expense_id}`} expense={props.expense} className="fa fa-pencil icon-btn text-warning" aria-hidden="true"></i>
            </Link>
